...
export default function CatalogSwiperV5({
  items,
  href,
  inquiryHref = "/register?intent=quote",
}: {
  items: Item[];
  href: string;
  inquiryHref?: string;
  ...
  return (
    <Swiper
      ...
      spaceBetween={16}
      slidesPerView={1.12}
      breakpoints={{ 560: { slidesPerView: 2.1 }, 860: { slidesPerView: 3.1 }, 1180: { slidesPerView: 4.15 } }}
          ...
          <article className={styles.productCard}>
            ...
            <div className={styles.productBody}>
              ...
              <div className={styles.productActions}>
                <Link href={href}>مشاهده در کاتالوگ</Link>
                <Link href={inquiryHref}>استعلام</Link>
              </div>
            </div>
          </article>
        </SwiperSlide>
